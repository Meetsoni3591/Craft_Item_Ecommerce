...
<head>
    ...
    <title>Wellness Gift</title>
    <link rel="stylesheet" href="Wellness_gift.css">
...
$query = "SELECT * FROM product_table WHERE category = 'gifting' AND sub_category = 'wellness gift';";
