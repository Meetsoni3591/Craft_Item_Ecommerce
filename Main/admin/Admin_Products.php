...
$sql = "SELECT id, name, description, price, image, category, sub_category, stock FROM product_table";
        ...
        <div class="content">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h2 class="mb-4">All Products Details</h2>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if (!empty($product['image'])): ?>
                                                                <img src="/ProjectCraft/Main/admin/CRUD/images/<?php echo htmlspecialchars($product['image']); ?>?t=<?php echo time(); ?>" alt="Product Image">
                                                            <?php else: ?>
                                                                <span>No image</span>
                                                            <?php endif; ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex flex-column">
                                                                <a href="edit_product.php?id=<?php echo $product['id']; ?>" class="btn btn-sm btn-primary mb-1">
                                                                    <i class="fa fa-edit"></i> Edit
                                                                </a>
                                                                <a href="Admin_Products.php?delete=<?php echo $product['id']; ?>" class="btn btn-sm btn-danger delete-btn" 
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    // The delete functionality is now handled with regular links and PHP
                });
            </script>
