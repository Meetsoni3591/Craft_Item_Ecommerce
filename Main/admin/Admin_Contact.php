...
if(isset($_GET['delete'])) {
    ...
    if($delete_result) {
        $success_msg = "Contact query deleted successfully";
    } else {
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        ...
                        <h2 class="mb-4">All Contact Queries</h2>
                        <h6 class="mb-4">Contact form Data</h6>
                            ...
                            <div class="table-container">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php if (!empty($contacts)): ?>
                                            ...
                                            <?php foreach ($contacts as $contact): ?>
                                                <tr>
                                                    ...
                                                    <td class="message-cell"><?php echo htmlspecialchars($contact['description'] ?? ''); ?></td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo $contact['id']; ?>)">
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="7" class="text-center">No contact queries found</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
            ...
            <script>
                function confirmDelete(contactId) {
                    Swal.fire({
                        title: 'Are you sure?',
                        text: 'You will not be able to recover this contact query!',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            window.location.href = 'Admin_Contact.php?delete=' + contactId;
                        }
                    });
                }
            </script>
