...
<body>
  <div class="breadcrumb">
    ...
    <span>Bedding & Cushions</span>
</div>
  <h1>Bedding & Cushions</h1>
  <!-- <div class="dropdown">
...
$query = "SELECT * FROM product_table WHERE category = 'homedecor' AND sub_category = 'Bedding';";
