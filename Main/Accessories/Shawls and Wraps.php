...
<head>
    ...
    <title>Shawls and Wraps</title>
    <link rel="stylesheet" href="Shawls and Wraps.css">
...
<body>
  <div class="breadcrumb">
    ...
    <span>Shawls and Wraps</span>
</div>
  <h1>Shawls and Wraps</h1>
  <!-- <div class="dropdown">
...
$query = "SELECT * FROM product_table WHERE category = 'Accessories' AND sub_category = 'shawls and wraps ';";
