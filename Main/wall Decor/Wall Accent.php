...
<head>
    ...
    <title>Wall Accent</title>
    <link rel="stylesheet" href="Wall Accent.css">
...
$query = "SELECT * FROM product_table WHERE category='Wall Decor' AND sub_category='Wall Accent';";
